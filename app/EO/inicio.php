...
<!-- Total de integrantes -->
    <div class="md-card uk-margin-medium-bottom">
        <div class="md-card-toolbar">
            ...
            <h3 class="md-card-toolbar-heading-text">
                TOTAL DE INTEGRANTES POR SEGMENTO
            </h3>
        </div>
        <div class="md-card-content">
                ...
                <div class="uk-grid" data-uk-grid-margin>
                    <div class="uk-width-medium-3-10">
                        ...
                        <select id="select_sindicato" name="select_sindicato" class="select" data-md-selectize data-md-selectize-bottom onchange="obtenerTablaSecciones(this.value);">
                            ...
                            <?php
                            $sql = "SELECT S.Id_seg,S.Nombre_Seg FROM segmento AS S WHERE S.Id_Enlace =:idEnlace";
                            ...
                            {
                                ?>
                                <option value="<?=$row['Id_seg']?>"><?=$row['Nombre_Seg']?></option>';
                                <?php
                            }
                            ?>
                        </select>
            ...
            <div class="uk-form-row">
                <div class="uk-grid" data-uk-grid-margin>
                    ...
                    <div class="uk-width-medium-5-10">
                        <form action="app/exportar/exportar3.php" method="post" target="_blank" id="FormularioExportacionDistrito">
                            <input id="exportarSindicatosDistrito" type="submit" class="md-btn md-btn-warning" style="float: right;" value="Exportar tabla">
        ...
        <div class="md-card-content">
            <div class="uk-form-row">
                <div class="uk-grid" data-uk-grid-margin>
                    ...
                    <div class="uk-width-medium-5-10">
                        <form action="app/exportar/exportar4.php" method="post" target="_blank" id="FormularioExportacionMunicipio">
                            <input id="exportarSindicatosMunicipio" type="submit" class="md-btn md-btn-warning" style="float: right;" value="Exportar tabla">
