    ...
    $options = '    
        <div class="uk-grid" data-uk-grid-margin>        
            ...
            <div class="uk-width-medium-1-2">
                ...
                <input type="text" class="md-input" id="input_direccion_PA_nw"  maxlength="250" required style="background-color: gainsboro;cursor: no-drop;" />
            </div>            
            <div class="uk-width-medium-1-2">
...
function AgregarUserPA(){
    ...
    // 
    $options="";
    $NombrePadron = isset($_POST["NomPadron"]) ? $_POST["NomPadron"] : "";//segmento
    $PA_New = Padrones::Crear($NombrePadron,$Id_EnlaceOP,$id_User);
...
function AgregarOperador(){
    ...
    $Seccion = isset($_POST["Seccion"]) ? $_POST["Seccion"] : "";
    // // 
    // $User_New = Contactos::Crear(4,$Nombre,$APP,$APM,$Direccion,$Telefono,$Correo,$Contraseña,$idU, $Seccion,$Id_EnlaceOP,$id_proyecto);
    // // id usuario registrado
    // $Results = $GLOBALS['pdo']->prepare("SELECT @@identity AS Id_Contacto");
    // $execute = $Results -> execute();
    // while( $row = $Results -> fetch()){
