    ...
    $options = '    
        <div class="uk-grid" data-uk-grid-margin>        
            ...
            <div class="uk-width-medium-1-2">
                ...
                <input type="text" class="md-input" id="input_direccion_PA_nw" maxlength="30" required disabled readonly style="background-color: gainsboro;cursor: no-drop;" />
            </div>            
            <div class="uk-width-medium-1-2">
            ...
            <div class="uk-width-medium-1-3" style="visibility: hidden; height: 0px;">
                <label>usuario*</label>
                <input type="password" class="md-input" id="input_id" maxlength="20" required disabled readonly style="background-color: gainsboro;cursor: no-drop;" value="5" />
            </div>
        </div>
        <br><br>    
            ';
...
function AgregarUserDetalle(){
    ...
    $Results = $GLOBALS['pdo']->prepare("SELECT T1.* FROM detalle_padron AS T1 
    INNER JOIN contactos AS T2 ON T1.Id_Contacto = T2.Id_Contacto
    ...
    if ($Results -> rowCount() > 0 ) {
        ...
        // 
        $User_New = Contactos::Crear(5,$Nombre,$APP,$APM,$Direccion,$Telefono,$Correo,$Contraseña,$idU, $Seccion,$Id_EnlaceOP,$id_proyecto);
...
function DetalleNW(){
    $options = '    
        <div class="uk-grid" data-uk-grid-margin>        
            ...
            <div class="uk-width-medium-1-2">
                <label>Direccion*</label>
                <input type="text" class="md-input" id="input_direccion_PA_nw" maxlength="30" required />
            </div>            
            <div class="uk-width-medium-1-2">
                <i class="material-icons">&#xE0CD;</i>
                <label for="masked_phone">Phone</label>
