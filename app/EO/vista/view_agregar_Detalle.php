        ...
        <div class="md-card-content">
            ...
            <div class="uk-grid" data-uk-grid-margin>        
                <div class="uk-width-medium-1-1">
                        ...
                        <input type="text" class="md-input" id="input_nombre_Padron" maxlength="200" value="<?= $nombre ?>" disabled readonly style="background-color: gainsboro;cursor: no-drop;"  />
                </div>  
            ...
            <br>
                ...
                <button type="button" class="md-btn md-btn-wave" onclick="regresar2('app/EO/vista/view_enlaces.php','Dia de la bandera',52);">Regresar</button>
