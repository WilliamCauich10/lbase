...
<div class="uk-grid uk-grid-width-large-1-4 " data-uk-sortable data-uk-grid-margin id="Pdatos" >
        ...
        <div class="uk-form-row">
                <div class="uk-grid" data-uk-grid-margin>
                    <div class="uk-width-medium-10-10">
                        <form action="app/exportar/exportar2.php" method="post" target="_blank" id="FormularioExportacionSindicatos">
    ...
    <div class="md-card uk-margin-medium-bottom">
        ...
        <div class="md-card-content">
            <div class="uk-form-row">
                <div class="uk-grid" data-uk-grid-margin>
                    <div class="uk-width-medium-3-10">
                        ...
                        <select id="select_sindicato" name="select_sindicato" class="select" data-md-selectize data-md-selectize-bottom>
                            <option value="0">TODOS</option>
                            <?php
                            $sql = "SELECT id_sindicato, nombre, siglas
                                    FROM sindicatos
                                    WHERE activo = 1
                                    AND id_proyecto = :idproyecto";
                            $stmt = $GLOBALS['pdo']->prepare($sql);
                            $stmt->bindValue(':idproyecto', $_SESSION['id_proyecto']);
                            $stmt->execute();
                            ...
                            {
                                ?>
                                <option value="<?=$row['id_sindicato']?>"><?=$row['siglas']?></option>';
                                <?php
                            }
                            ?>
                        </select>
                    ...
                    <div class="uk-width-medium-7-10">
                        <form action="app\views\exportar.php" method="post" target="_blank" id="FormularioExportacion">
                            <input id="exportarSecciones" type="button" class="md-btn md-btn-warning" style="float: right;" value="Exportar">
            ...
            <div class="uk-form-row">
                <div class="uk-grid" data-uk-grid-margin>
                    <div class="uk-width-medium-10-10">
                        <form action="app\views\exportar5.php" method="post" target="_blank" id="FormularioExportacionGenero">
                            <input id="exportarGenero" type="button" class="md-btn md-btn-warning" style="float: right;" value="Exportar tabla">
                            <input type="hidden" id="tabla_genero" name="tabla_genero" />
                        </form>
                    </div>
                </div>
            </div>
            ...
            <div class="uk-form-row">
                <div class="uk-grid" data-uk-grid-margin>
                    <div class="uk-width-medium-5-10">
                        <div class="mGraph-wrapper">
                            <div id="graphGenero" class="mGraph" data-uk-check-display>

                            </div>
                        </div>
                    </div>
                    <div class="uk-width-medium-5-10">
                        <table id="tblGenero" class="uk-table uk-table-hover">
            ...
            <div class="uk-form-row">
                <div class="uk-grid" data-uk-grid-margin>
                    <div class="uk-width-medium-3-10">
                        ...
                        <select id="select_distrito" name="select_distrito" class="select" data-md-selectize data-md-selectize-bottom>
            ...
            <div class="uk-form-row">
                <div class="uk-grid" data-uk-grid-margin>
                    <div class="uk-width-medium-3-10">
                        ...
                        <select id="select_municipio" name="select_municipio" class="select" data-md-selectize data-md-selectize-bottom>
                            <option value="">Seleccione el municipio</option>
                            <?php
                            $sql = "SELECT id_ine, nom_geo FROM catgeo";
                            $stmt = $GLOBALS['pdo']->prepare($sql);
                            $stmt->execute();
