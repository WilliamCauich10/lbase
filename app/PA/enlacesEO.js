...
function principalDatos() {
    $("#Pdatos").load("app/PA/controlador/padron/datosPrincipal.php");
    $("#Pdatos").show();    
}
function principaldatosEnlace() {
    $.ajax({
        url: "app/PA/controlador/dashboard.php",
        type: "POST",
...
function obtenerTablaSecciones(padron) {
    $.ajax({
        url: "app/PA/controlador/dashboard.php",
        type: "POST",
        data: { tipo : 'DispersionDashboard',padron: padron},
        success: function(data){
            ...
            $("#datos_a_enviar").val($("<div><H3>padron: " + $("#nombre_sindicato").val() + "</H3>").append( $("#tblSecciones").eq(0).clone()).html());
        }
    });
}
            ...
            var chart = new Highcharts.Chart({
                ...
                series: [{
                    ...
                    data: (function(){
                        ...
                        {
                            data.push({
                                'name': rawdata[i]["Nom_Padron"],
                                'y': parseInt(rawdata[i]["USUARIOS"])
                            })
                        }
                        return data;
                    })()
...
function exportarDetalle(){
    ...
    location.href='app/exportar/exportarDistrito.php?distrito=' +distrito+'&tipo=PA';
}
function exportarDetalleMunicipio(){
    var municipio = $("#select_municipio").val();
    location.href='app/exportar/exportarMunicipio.php?municipio=' + municipio+'&tipo=PA';
}
// modal Padron
// function modal_EnlacesAP(idPadron,Tipo) {
//     Tipo_opt =Tipo;
//     $("#ModalEO").load("app/PA/controlador/enlaces/modalesEO.php",{idPadron: idPadron, tipo: Tipo_opt});
//     $("#ModalEO").show();
// }
// modal contactos para padron
// function modal_ContactosEO(idPadron,Tipo) {
//     Tipo_opt =Tipo;
//     $("#ModalContactosEO").load("app/PA/controlador/enlaces/modalesEO.php",{idPadron: idPadron, tipo: Tipo_opt});
    ...
    $('#Busqueda_User_Create_EO').submit(function() {
        $.ajax({
            ...
            success: function(data) {
                ...
                $("#ResultadosBusqCrear_EO").load('app/PA/controlador/enlaces/tabla_busquedaUser.php',{nombre: Nombre, apellido: APP,idPadron: idPadron,apellidoMat: APM});
    ...
    $('#Busqueda_User_Create_PA').submit(function() {
        $.ajax({
            ...
            success: function(data) {
                ...
                $("#ResultadosBusqCrear_PA").load('app/PA/controlador/padron/tabla_busquedaUser.php',{nombre: Nombre, apellido: APP, apellidoMat:APM,idPadron: idPadron,});
...
function UserSelect(IdUsuario,IdPadron) {
    ...
    $.ajax({
        url: "app/PA/controlador/crear.php",
        type: "POST",
...
function createEO(){
    ...
    var modal = UIkit.modal.blockUI('<div class=\'uk-text-center\'><br/><img class=\'uk-margin-top\' src=\'assets/img/spinners/spinner.gif\' alt=\'\'>');
    $.ajax({
        url: "app/PA/controlador/enlaces/CrarDetalle.php",
        type: "POST",
        data: {tipo: 'DetalleNW'},
        success: function(data){
            $('#form1').html(data.options);
    ...
    // // formEO
    // $("#formEO").load('app/PA/controlador/enlaces/formEO.php',{tipo: 'Crear',idUser: idUser,idPadron: idPadron, NomPadron: NomPadron});
    // $("#formEO").show();
}
...
function createPA(){
    ...
    // // formPA
    // $("#formPA").load('app/PA/controlador/padron/formPA.php',{tipo: 'CrearUserPadron'});
    // $("#formPA").show();
}
...
function FormPadDeNW(idPadon,IdUsuario,NomPadron) {
    ...
    $('#Crear_PadronDetalle_Form_NW').submit(function() {
        $.ajax({
            ...
            success: function(data) {                
                // Guardar Datos     
                $("#resultadosContactos").load('app/PA/controlador/enlaces/acciones.php',{OPT: 'CrearPadronDetalleNW',idpadron: idPadon,idUser: IdUsuario,NomPadron: NomPadron,
    ...
    $('#Crear_Padron_Form').submit(function() {
        $.ajax({
            ...
            success: function(data) {    
                ...
                // }
                // setTimeout(function(){ 
                //     $("#resultados").load('app/PA/controlador/padron/acciones.php',{OPT: 'CrearPadronUpUser',id_enlace: idEnlace,NombrePadron: NombrePadron,
...
function Crear_Padron_NwUser(idEnlace) {
    ...
    $('#formCrearPA').submit(function() {
        $.ajax({
            ...
            success: function(data) {                
                // Guardar Datos                 
                $("#resultados").load('app/PA/controlador/padron/acciones.php',{OPT: 'CrearPadronUpUserNW',id_enlace: idEnlace,NombrePadron: NombrePadron,
                Nombre: Nombre, APP: APP, APM: APM,Direccion: Direccion, Telefono: Telefono,Correo: Correo, Contraseña: Contraseña, Seccion: Seccion});
                $("#resultados").show();
            }
        });
...
function borrarPadron(idPadron,idResponasable,id_cambio){
    $("#resultados").load('app/PA/controlador/padron/acciones.php',{OPT: 'BorrarPadron',idPadron: idPadron, idResponasable: idResponasable, id_cambio: id_cambio});
    $("#resultados").show();
}
function PrincilaEnlace() {    
    principalDatos();
    $("#page_content").load('app/PA/vista/view_enlaces.php');
    $("#page_content").show();
}
function PrincipalDetalles(NombrePadron,padron) {
    principalDatos();
    $('#TablaPadron').load('app/PA/controlador/padron/tablaPrincipal.php');
    $("#TablaPadron").show();
    // 
    $("#Contactos_Tabla_PA").load('app/PA/vista/view_contactos.php',{nombre: NombrePadron, id :padron});
...
function Crear_PadronDetalle(padron,usuario,NombrePadron) {
    ...
    $('#Crear_PadronDetalle_Form').submit(function() {
        $.ajax({
            ...
            success: function(data) {                
                // Guardar Datos                 
                $("#resultadosContactos").load('app/PA/controlador/enlaces/acciones.php',{OPT: 'CrearPadronDetalleUp',idpadron: padron,idUser: usuario,NombrePadron: NombrePadron,
                Nombre: Nombre, APP: APP, APM: APM,Direccion: Direccion, Telefono: Telefono,Correo: Correo, Contraseña: Contraseña, Seccion: Seccion});
                $("#resultadosContactos").show();
            }
        });
...
function borrarUserDetallePadron(id_usuario, idPadron,NombrePadron,id_cambio) {
    $("#resultadosContactos").load('app/PA/controlador/enlaces/acciones.php',{OPT: 'borrarUserDetalle',id_User : id_usuario, id_cambio: id_cambio,idPadron:idPadron,NombrePadron:NombrePadron});
    $("#resultadosContactos").show();
}
function CrearPadrones(idPadron,Tipo) {
    Tipo_opt =Tipo;
    $("#page_content").load("app/PA/vista/view_agregar_Padron.php");
    $("#page_content").show();
    var modal = UIkit.modal.blockUI('<div class=\'uk-text-center\'><br/><img class=\'uk-margin-top\' src=\'assets/img/spinners/spinner.gif\' alt=\'\'>');
    $.ajax({
        url: "app/PA/controlador/crear.php",
...
function CrearDetalle(idPadron,nombrePA,Tipo) {
    Tipo_opt =Tipo;
    $("#page_content").load("app/PA/vista/view_agregar_Detalle.php",{ idPadron: idPadron,nombrePA:nombrePA});
    $("#page_content").show();
    var modal = UIkit.modal.blockUI('<div class=\'uk-text-center\'><br/><img class=\'uk-margin-top\' src=\'assets/img/spinners/spinner.gif\' alt=\'\'>');
    $.ajax({
        url: "app/PA/controlador/enlaces/CrarDetalle.php",
...
function formSaveDetallebtn(nombrePA,IdPA) {
    ...
    var sexo = document.forms["formSaveDetalle"]["val_radio_male"].value; 
    var año = document.forms["formSaveDetalle"]["masked_date"].value;  
    var
    patron = / /g,
    nuevoValor    = "",
    Telefono = cadena.replace(patron, nuevoValor);
        ...
        $('#formSaveDetalle').submit(function() {
            event.preventDefault();
                    $.ajax({
                        type: 'POST',
                        url: 'app/PA/controlador/enlaces/CrarDetalle.php',
                        data: {tipo: 'AgregarUserDetalle',idpadron: IdPA,NomPadron: PA,Nombre: Nombre, APP: APP, APM: APM,Direccion: Direccion, Telefono: Telefono,Correo: Correo, Contraseña: Contraseña, Seccion: Seccion,idU: idU,sexo: sexo, nacimiento: año},
                        success: function(data){
                            // $("#page_content").load('app/PA/vista/view_enlaces.php');
                            // $("#page_content").show();
                            // modal.hide();
                            ...
                            // $("#Contactos_Tabla_PA").load('app/PA/vista/view_contactos.php',{nombre: 'prueba usuario nuevo', id :'55'});
                            // $("#Contactos_Tabla_PA").show();
                        }
                });
                $("#page_content").load('app/PA/vista/view_enlaces.php');
...
function modal_CreatePadron() {
    $("#ModalCrearContacEO").load("app/PA/controlador/crear.php",{idPadron: '0', tipo: 'BusquedaUserPadron'});
    $("#ModalCrearContacEO").show();    
}
function modal_CreateDetalle(){
    $("#ModalCrearDetalleEO").load("app/PA/controlador/enlaces/CrarDetalle.php",{tipo: 'BusquedaDetalle'});
