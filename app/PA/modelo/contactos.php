        ...
        try{
            ...
            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                ...
                <div class="uk-width-medium-1-2">
                    ...
                    <input type="text" class="md-input" id="input_direccion_PA_nw" maxlength="400"   value="'.$row['Direccion'].'" />
                </div>            
                <div class="uk-width-medium-1-2">                
                ...
                <div class="uk-width-medium-1-2">
                    <label>Seccion *</label>
                    <input class="md-input masked_input" id="input_Seccion_PA" type="text" data-inputmask="\'alias\': \'numeric\'" data-inputmask-showmaskonhover="true" value="'.$row['Seccion'].'" />                    
                </div>   
                <div class="uk-width-medium-1-2">
                        ...
                        if ($row['Sexo'] == 'M') {
                            $options .='
                                <span class="icheck-inline">
                                    <input type="radio" name="val_radio_gender" id="val_radio_male" value=\'H\' data-md-icheck  />
